...
const IntegrationCard: React.FC<IntegrationCardProps> = ({ name, description, logo, connected: initialConnected }) => {
    ...
    return (
        <div className="bg-card rounded-lg border border-border p-6 flex flex-col">
            ...
            <p className="text-text-secondary text-sm flex-1 mb-6">{description}</p>
                ...
                <span className={`text-xs font-medium ${connected ? 'text-green-400' : 'text-slate-400'}`}>
                 ...
                 <label htmlFor={`toggle-${name}`} className="flex items-center cursor-pointer">
                    <div className="relative">
                        ...
                        <div className={`block w-14 h-8 rounded-full ${connected ? 'bg-primary' : 'bg-background'}`}></div>
...
const Integrations: React.FC = () => {
    ...
    return (
        <div className="p-8">
            ...
            <p className="text-text-secondary mb-6">Connect your tools to centralize feedback.</p>
